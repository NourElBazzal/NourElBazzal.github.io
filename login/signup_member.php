...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($chosenService != -1 && $disabilityType != -1) {
    // Insert user data into the 'user' table
    $sql = "INSERT INTO users (FullName, Username, Email, Password, PhoneNumber, role_id) VALUES ('$name', '$username', '$email','$password', '$phone', 2)";
    ...
    if ($conn->query($sql) === TRUE) {
      ...
      $sqlInsertDisability = "INSERT INTO disabilities_users (user_id, disability_id) VALUES ('$user_id', '$disabilityType')";

      if ($conn->query($sqlInsertService) === TRUE && $conn->query($sqlInsertDisability) === TRUE) {
          ...
          <div class="forms-wrap">
            ...
            <form class="sign-in-form" method="POST" enctype="multipart/form-data">
              ...
              <div class="actual-form">
                ...
                <div class="input-wrap">
                  <input type="number" class="input-field" autocomplete="off" name="disabilityID" required/>
               ...
               <select class="filter-select" name="disabilityType" id="disabilityType"> 
                <option id="-1">Disability Type</option>
                  <?php
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    $Disabilityname= $row["DisabilityName"];
                     ...
                     echo "<option value='$id'>$Disabilityname</option>";                    
                  }
                ...
                <select class="filter-select" name="chosen-service" id="chosen-service" required >
                <option id="-1">Service you want to benefit from</option>
                <?php
