...
$listQuery = "SELECT *  FROM users WHERE role_id=2";
...
if (isset($_POST['delete'])) {
    ...
    if ($conn->query($deleteQuery)) {
        echo "<div class='alert alert-success'>Member with id '$deleteCode' has been deleted successfully!</div>";
...
<div class="container">
    ...
    <h2>List of Available Members</h2>
    <table>
       <thead>
        <tr>
            <th>Member ID</th>
